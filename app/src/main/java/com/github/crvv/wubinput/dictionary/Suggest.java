...
import com.github.crvv.wubinput.wubi.utils.SuggestionResults;
...
public final class Suggest {
    ...
    private static String getWhitelistedWordOrNull(final ArrayList<SuggestedWords.SuggestedWordInfo> suggestions) {
    ...
    private void getSuggestedWordsForNonBatchInput(final WordComposer wordComposer,
        ...
        final boolean didRemoveTypedWord =
                SuggestedWords.SuggestedWordInfo.removeDups(wordComposer.getTypedWord(), suggestionsContainer);
...
//                    suggestionResults.first(), consideredWord, mAutoCorrectionThreshold);
        ...
        if (!TextUtils.isEmpty(typedWord)) {
            suggestionsContainer.add(0, new SuggestedWords.SuggestedWordInfo(typedWord,
                    SuggestedWords.SuggestedWordInfo.MAX_SCORE, SuggestedWords.SuggestedWordInfo.KIND_TYPED,
...
//    }
    ...
    /* package for test */ static SuggestedWords.SuggestedWordInfo getTransformedSuggestedWordInfo(
        ...
        return new SuggestedWords.SuggestedWordInfo(sb.toString(), wordInfo.mScore, wordInfo.mKindAndFlags,
